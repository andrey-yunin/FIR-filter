...
# setting SOPC_SYSID_BASE_ADDRESS is 0x808a060
SOPC_SYSID_FLAG += --sidp=0x808a060
ELF_PATCH_FLAG  += --sidp 0x808a060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1640375867
SOPC_SYSID_FLAG += --timestamp=1640375867
ELF_PATCH_FLAG  += --timestamp 1640375867
