...
#define ALTERA_AVALON_TIMER_REGS_H_  // linker will skip all lines until the next
//#endif
#include <io.h>                      // include HAL macros
#include <system.h>                  // include base address definitions
// define device drive macros
...
#endif // ALTERA_AVALON_TIMER_REGS_H_ // This ends the #ifndef
