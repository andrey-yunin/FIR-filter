...
(
   ...
   input logic resetn,
   // AVST result_in
   input logic result_in_valid,
   output logic result_in_ready,
   input logic [31:0] result_in_data,
   input logic start,
   output logic busy,
   output logic done,
   input logic stall,
   // AVS avs_result_buffer
   input logic avs_result_buffer_enable,
   input logic avs_result_buffer_read,
   input logic avs_result_buffer_write,
   input logic [8:0] avs_result_buffer_address,
   input logic [31:0] avs_result_buffer_writedata,
   input logic [3:0] avs_result_buffer_byteenable,
   output logic [31:0] avs_result_buffer_readdata,
   output logic avs_result_buffer_readdatavalid
);
   genvar __i;
   genvar __j;
   ...
   // INST result_buffer_internal of result_buffer_function_wrapper
   result_buffer_function_wrapper result_buffer_internal
   (
      .clock(clock),
      .resetn(resetn),
      // AVST avst_iord_bl_result_in
      .avst_iord_bl_result_in_valid(result_in_valid),
      .avst_iord_bl_result_in_ready(result_in_ready),
      .avst_iord_bl_result_in_data(result_in_data),
      .start(start),
      .busy(busy),
      .done(done),
      .stall(stall),
      ...
      // AVM avm_result_buffer
      .avm_result_buffer_enable(local_avm_aspace6_enable[0][1]),
      .avm_result_buffer_read(local_avm_aspace6_read[0][1]),
      .avm_result_buffer_write(local_avm_aspace6_write[0][1]),
      .avm_result_buffer_burstcount(local_avm_aspace6_burstcount[0][1]),
      .avm_result_buffer_address(local_avm_aspace6_address[0][1]),
      .avm_result_buffer_writedata(local_avm_aspace6_writedata[0][1]),
      .avm_result_buffer_byteenable(local_avm_aspace6_byteenable[0][1]),
      .avm_result_buffer_waitrequest(local_avm_aspace6_waitrequest[0][1]),
      .avm_result_buffer_readdata(local_avm_aspace6_readdata[0][1]),
      .avm_result_buffer_readdatavalid(local_avm_aspace6_readdatavalid[0][1]),
      .avm_result_buffer_writeack(local_avm_aspace6_writeack[0][1]),
      // AVS avs_result_buffer
      .avs_result_buffer_enable(avs_result_buffer_enable),
      .avs_result_buffer_read(avs_result_buffer_read),
      .avs_result_buffer_write(avs_result_buffer_write),
      .avs_result_buffer_address(avs_result_buffer_address),
      .avs_result_buffer_writedata(avs_result_buffer_writedata),
      .avs_result_buffer_byteenable(avs_result_buffer_byteenable),
      .avs_result_buffer_readdata(avs_result_buffer_readdata),
      .avs_result_buffer_readdatavalid(avs_result_buffer_readdatavalid)
   );
   ...
   begin:local_mem_system_aspace6
      ...
      begin:local_mem_group
         ...
         begin:port1bank0
            ...
            // INST data_ic of result_buffer_internal_interconnect_0
            result_buffer_internal_interconnect_0 data_ic
            (
               .clock(clock),
               .resetn(resetn),
               // ICM m
         ...
         begin:port2bank0
            ...
            // INST data_ic of result_buffer_internal_interconnect_1
            result_buffer_internal_interconnect_1 data_ic
            (
               .clock(clock),
               .resetn(resetn),
               // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE result_buffer_internal_interconnect_0
/////////////////////////////////////////////////////////////////
module result_buffer_internal_interconnect_0
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE result_buffer_internal_interconnect_1
/////////////////////////////////////////////////////////////////
module result_buffer_internal_interconnect_1
(
   input logic clock,
