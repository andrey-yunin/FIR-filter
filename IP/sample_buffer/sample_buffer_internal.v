...
(
   ...
   input logic sample_out_ready,
   output logic [15:0] sample_out_data,
   ...
   // AVS avs_sample_buffer
   input logic avs_sample_buffer_enable,
   input logic avs_sample_buffer_read,
   input logic avs_sample_buffer_write,
   input logic [8:0] avs_sample_buffer_address,
   input logic [31:0] avs_sample_buffer_writedata,
   input logic [3:0] avs_sample_buffer_byteenable,
   output logic [31:0] avs_sample_buffer_readdata,
   output logic avs_sample_buffer_readdatavalid
);
   genvar __i;
   genvar __j;
   ...
   // INST sample_buffer_internal of sample_buffer_function_wrapper
   sample_buffer_function_wrapper sample_buffer_internal
   (
      .clock(clock),
      .resetn(resetn),
      // AVST avst_iowr_bl_sample_out
      .avst_iowr_bl_sample_out_valid(sample_out_valid),
      .avst_iowr_bl_sample_out_ready(sample_out_ready),
      .avst_iowr_bl_sample_out_data(sample_out_data),
      .done_irq(done_irq),
      // AVM avm_sample_buffer
      .avm_sample_buffer_enable(local_avm_aspace5_enable[0][0]),
      .avm_sample_buffer_read(local_avm_aspace5_read[0][0]),
      .avm_sample_buffer_write(local_avm_aspace5_write[0][0]),
      .avm_sample_buffer_burstcount(local_avm_aspace5_burstcount[0][0]),
      .avm_sample_buffer_address(local_avm_aspace5_address[0][0]),
      .avm_sample_buffer_writedata(local_avm_aspace5_writedata[0][0]),
      .avm_sample_buffer_byteenable(local_avm_aspace5_byteenable[0][0]),
      .avm_sample_buffer_waitrequest(local_avm_aspace5_waitrequest[0][0]),
      .avm_sample_buffer_readdata(local_avm_aspace5_readdata[0][0]),
      .avm_sample_buffer_readdatavalid(local_avm_aspace5_readdatavalid[0][0]),
      .avm_sample_buffer_writeack(local_avm_aspace5_writeack[0][0]),
      // AVM avm_unnamed_sample_buffer5
      .avm_unnamed_sample_buffer5_enable(local_avm_aspace5_enable[0][1]),
      .avm_unnamed_sample_buffer5_read(local_avm_aspace5_read[0][1]),
      .avm_unnamed_sample_buffer5_write(local_avm_aspace5_write[0][1]),
      .avm_unnamed_sample_buffer5_burstcount(local_avm_aspace5_burstcount[0][1]),
      .avm_unnamed_sample_buffer5_address(local_avm_aspace5_address[0][1]),
      .avm_unnamed_sample_buffer5_writedata(local_avm_aspace5_writedata[0][1]),
      .avm_unnamed_sample_buffer5_byteenable(local_avm_aspace5_byteenable[0][1]),
      .avm_unnamed_sample_buffer5_waitrequest(local_avm_aspace5_waitrequest[0][1]),
      .avm_unnamed_sample_buffer5_readdata(local_avm_aspace5_readdata[0][1]),
      .avm_unnamed_sample_buffer5_readdatavalid(local_avm_aspace5_readdatavalid[0][1]),
      .avm_unnamed_sample_buffer5_writeack(local_avm_aspace5_writeack[0][1]),
      // AVS avs_cra
      ...
      // AVS avs_sample_buffer
      .avs_sample_buffer_enable(avs_sample_buffer_enable),
      .avs_sample_buffer_read(avs_sample_buffer_read),
      .avs_sample_buffer_write(avs_sample_buffer_write),
      .avs_sample_buffer_address(avs_sample_buffer_address),
      .avs_sample_buffer_writedata(avs_sample_buffer_writedata),
      .avs_sample_buffer_byteenable(avs_sample_buffer_byteenable),
      .avs_sample_buffer_readdata(avs_sample_buffer_readdata),
      .avs_sample_buffer_readdatavalid(avs_sample_buffer_readdatavalid)
   );
   ...
   begin:local_mem_system_aspace5
      ...
      begin:local_mem_group
         ...
         begin:port1bank0
            ...
            // INST data_ic of sample_buffer_internal_interconnect_0
            sample_buffer_internal_interconnect_0 data_ic
            (
               .clock(clock),
               .resetn(resetn),
               // ICM m
         ...
         begin:port2bank0
            ...
            // INST data_ic of sample_buffer_internal_interconnect_1
            sample_buffer_internal_interconnect_1 data_ic
            (
               .clock(clock),
               .resetn(resetn),
               // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE sample_buffer_internal_interconnect_0
/////////////////////////////////////////////////////////////////
module sample_buffer_internal_interconnect_0
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE sample_buffer_internal_interconnect_1
/////////////////////////////////////////////////////////////////
module sample_buffer_internal_interconnect_1
(
   input logic clock,
